...
suite =
    describe "Levenshtein"
        [ benchmark1 "paragraphify" LatexParser.Paragraph.paragraphify qftIntroText
        , benchmark2 "levenshtein id" levenshtein pp pp
        , benchmark2 "levenshtein 2 substitutions" levenshtein pp qq

        --, benchmark2 "levenshtein 1 deletion" levenshtein pp rr
        ]


pp =
    LatexParser.Paragraph.paragraphify qftIntroText


{-| Two substitutions
-}
qq =
    LatexParser.Paragraph.paragraphify qftIntroText2


{-| One deletion
-}
rr =
    LatexParser.Paragraph.paragraphify qftIntroText3
...
\\subsection{Thought experiment: electron in a very small box}
...
\\subsubsection{Fermat's principle II}

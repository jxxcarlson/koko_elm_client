...
latexStateReducerDict =
    Dict.fromList
        ...
        , ( ( "macro", "section" ), \x y -> SRH.macroSection x y )
        , ( ( "macro", "subsection" ), \x y -> SRH.macroSubsection x y )
        , ( ( "macro", "subsubsection" ), \x y -> SRH.macroSubsubsection x y )
        , ( ( "macro", "title" ), \x y -> SRH.macroTitle x y )
        , ( ( "macro", "author" ), \x y -> SRH.macroAuthor x y )
        , ( ( "macro", "date" ), \x y -> SRH.macroDate x y )
        , ( ( "macro", "email" ), \x y -> SRH.macroEmail x y )
        , ( ( "macro", "revision" ), \x y -> SRH.macroRevision x y )
        , ( ( "env", "theorem" ), \x y -> SRH.envTheorem x y )
        , ( ( "env", "proposition" ), \x y -> SRH.envProposition x y )
        , ( ( "env", "lemma" ), \x y -> SRH.envLemma x y )
        , ( ( "env", "definition" ), \x y -> SRH.envDefinition x y )
        , ( ( "env", "corollary" ), \x y -> SRH.envCorollary x y )

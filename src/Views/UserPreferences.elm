...
blurbPanel model =
    (Keyed.row PaleBlue
        ...
        [ ( (toString model.counter)
          , (Input.multiline
                Mono
                [ width (percent 100), height (px 150), yScrollbar, padding 20 ]
                { onChange = UpdateTextInputBuffer
                , value = model.current_user.blurb

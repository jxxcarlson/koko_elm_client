...
pageSelector model =
    row NavBar
        ...
        , Utility.visibleIf (model.current_user.admin == True) (el (activeButton AdminPage model) [ EE.onClick (GoTo AdminPage), alignBottom, height (px 30), padding 8 ] (text "Admin"))
        ]
